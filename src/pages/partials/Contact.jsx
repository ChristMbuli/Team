...
const Contact = () => {
  return (
    <div class="my-6" id="contact">
      <div class="max-w-6xl mx-auto bg-gray-900 rounded-lg">
        <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
          <div>
            <h1 class="text-4xl font-extrabold text-white">Nous Contacter</h1>
            ...
            <ul class="flex mt-12 space-x-4">
              <li class="bg-indigo-600 hover:bg-indigo-500 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
          ...
          <div class="bg-gray-200 p-6 rounded-lg">
            <p class="text-sm font-semibold text-[#333]">Nos Services</p>
            <div class="space-y-4 max-lg:mt-4">
              <button
                type="button"
                class="px-4 py-2 rounded-md  text-black text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4"
              >
                Web design
              </button>
              <button
              ...
              <button
                type="button"
                class="px-4 py-2 rounded-md text-black text-sm tracking-wider font-medium outline-none border-2 border-gray-300"
              >
                Marketing
              </button>
            </div>
            <form class="mt-8 space-y-4">
              ...
              ></textarea>
              <div class="justify-center flex sm:flex-row flex-col gap-5 w-full">
                <a
                  href="#"
